...
<body>
  <div class="card">
    <div class="badge">🟢 Сервер онлайн • NeoForge 1.21.1 • Лаунчер v3.5.14</div>
    ...
    <div class="btn-group">
      <a href="/files/launchers/VozduCraft-Windows-Setup.exe?v=3.5.14" class="btn btn-win">
        🪟 Скачать для Windows (.exe Установщик)
      </a>
      <a href="/files/launchers/VozduCraft-macOS-Setup.dmg?v=3.5.14" class="btn btn-mac">
  ...
  res.json({
    ...
    version: '3.5.14',
    downloads: {
      windows: `${req.protocol}://${req.get('host') || '185.221.213.43:3000'}/files/launchers/VozduCraft-Windows-Setup.exe?v=3.5.14`,
      macos: `${req.protocol}://${req.get('host') || '185.221.213.43:3000'}/files/launchers/VozduCraft-macOS-Setup.dmg?v=3.5.14`
    }
  });
});
